...
(function () {
  let field = document.querySelectorAll(".grid-list");
  let li = Number.from(field.children);

  function FilterProduct() {
    for (let i of li) {
      const name = i.querySelector(h3[id]);
